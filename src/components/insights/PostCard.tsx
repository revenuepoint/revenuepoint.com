...
export function PostCard({
  ...
  if (featured) {
    return (
      <Link
        href={href}
        className="group grid grid-cols-1 md:grid-cols-[1.2fr_1fr] gap-6 md:gap-10 items-stretch border border-ruleSoft bg-cream overflow-hidden hover:border-navySoft transition-colors relative"
      >
        <span aria-hidden="true" className="absolute left-0 top-0 h-px w-full bg-rule" />
        <span aria-hidden="true" className="absolute left-0 top-0 h-px w-12 bg-navySoft z-10" />
        ...
        <div className="p-6 md:p-8 flex flex-col">
          <p className="font-mono text-[10px] uppercase tracking-[0.16em] text-navySoft mb-3">
            Featured · long read
          </p>
          ...
          <h3 className="font-serif text-[1.5rem] lg:text-[1.75rem] font-medium text-ink leading-tight group-hover:text-navySoft transition-colors">
            {meta.title}
          </h3>
  ...
  return (
    <Link
      href={href}
      className="group flex flex-col border border-ruleSoft bg-cream overflow-hidden hover:border-navySoft transition-colors relative"
    >
      <span aria-hidden="true" className="absolute left-0 top-0 h-px w-full bg-rule z-10" />
      <span aria-hidden="true" className="absolute left-0 top-0 h-px w-8 bg-navySoft z-10" />
      ...
      <div className="p-5 flex-1 flex flex-col">
        ...
        <h3 className="font-serif text-[1.0625rem] font-medium text-ink leading-snug group-hover:text-navySoft transition-colors">
          {meta.title}
        </h3>
