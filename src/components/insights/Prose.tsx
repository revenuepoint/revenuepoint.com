  ...
  return (
    <div
      className="
        ...
        [&>ul>li]:relative [&>ul>li]:pl-6 [&>ul>li]:before:content-['→'] [&>ul>li]:before:absolute [&>ul>li]:before:left-0 [&>ul>li]:before:text-crimson [&>ul>li]:before:font-mono
        [&>ol]:list-none [&>ol]:pl-0 [&>ol]:space-y-2 [&>ol]:counter-reset:item
        [&>ol>li]:relative [&>ol>li]:pl-8 [&>ol>li]:before:content-[counter(item,lower-roman)'.'] [&>ol>li]:before:absolute [&>ol>li]:before:left-0 [&>ol>li]:before:text-crimson [&>ol>li]:before:font-serif [&>ol>li]:before:italic [&>ol>li]:counter-increment:item
        [&_a]:text-crimson [&_a]:underline [&_a]:underline-offset-2 [&_a]:decoration-crimson/40 hover:[&_a]:decoration-crimson
        [&_strong]:font-semibold [&_strong]:text-ink
        [&_em]:italic [&_em]:text-crimson
