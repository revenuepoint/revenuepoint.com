    ...
    <AnimatePresence>
      {open && (
        <motion.div
          ...
          className="absolute bottom-4 left-4 z-40 max-w-[260px] rounded-md border border-border bg-white shadow-xl px-3 py-2 flex items-start gap-2"
          aria-hidden="true"
        >
          ...
          <div className="min-w-0 flex-1">
            ...
            <p className="text-[9px] text-mutedText mt-0.5">
